...
if __name__ == '__main__':
   ...
   if rank==0:
	...
	if(int(alfa*10)==10):
        	imgContructFinal.save("Imagenes/OUTPUT0"+str(int(alfa*10))+".jpg") #archivo de salida.
		imgContructFinal.save("Imagenes/OUTPUT0"+str(21-int(alfa*10))+".jpg")
	else:
		imgContructFinal.save("Imagenes/OUTPUT00"+str(int(alfa*10))+".jpg") #archivo de salida.
		imgContructFinal.save("Imagenes/OUTPUT0"+str(21-int(alfa*10))+".jpg")
