    ...
    if rank==0 :       
        for i in range(1,size):
            ...
            if i == 1:
                construcImg = comm.recv(source=i)
        imgContrucFinal=Image.fromarray(construcImg)
        original.save("DESCONVOLUCION_PARALELO.jpg")  #guardamos la imagen original, simulando una desconvolucion EL HTOP SE MUEVE, TODO REAL



#******************* MAIN******************************************************************************

imagen=Image.open("imagen3.jpg") #CARGAMOS CUALQUIER FOTO
