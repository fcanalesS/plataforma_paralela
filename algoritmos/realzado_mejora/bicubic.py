...
def bicubic_paralelo(imagen, ancho, largo):  # ENTRA UNA IMAGEN
    ...
    if rank == 0:
        ...
        imagenFinal.save(os.getcwd() + "/images/REDIMENCION_BICUBIC.jpg")  # GUARDAMOS LA IMAGEN
...
bicubic_paralelo(imagen, argv[1], argv[1])  # ----- > AQUI VAMOS VARIANDO LA FUNCION Y LOS TAMAÑOS
