...
def main():
    ...
    if rank == 0:
        ruta="imagen1.jpg" #CARGAR LA IMAGEN QUE SE DESEA
    ...
    if rank != 0:
        ...
        arrImgSalida = bordes(arrTrabajo, mascara1)    #enviar el arreglo RGB a transformarlo en arreglo negativo de la imagen
    ...
    if rank==0 :       #recibe los arreglos y los junta uno abajo del otro
        ...
        imgContrucFinal.save("BORDE_PARALELO.jpg")
